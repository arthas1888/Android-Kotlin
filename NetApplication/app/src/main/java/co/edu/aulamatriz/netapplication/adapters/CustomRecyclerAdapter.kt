...
class CustomRecyclerAdapter() :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.nameTextView!!.text = myDataset?.getString(myDataset!!.getColumnIndex("name"))
        holder.cityTextView!!.text = myDataset?.getString(myDataset!!.getColumnIndex("lastName"))
